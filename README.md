...
- [`docs/CONTEXTO.md`](docs/CONTEXTO.md) — leer primero: qué es y dónde retomar
- [`docs/PLAN.md`](docs/PLAN.md) — roadmap por fases
- [`docs/CHANGELOG.md`](docs/CHANGELOG.md) — registro de sesiones
- [`docs/GDD_NIVELES.md`](docs/GDD_NIVELES.md) — los 31 reinos
