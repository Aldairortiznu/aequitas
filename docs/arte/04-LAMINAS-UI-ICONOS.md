...
| Id              | Escena                    | Composición                                                                                                                                                                                                                                                                                                           | Luz                                                                  |
| --------------- | ------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------- |
| `ep00-lamina-1` | La noche de la Fractura   | Gran plano general de Puerto Baluarte a oscuras desde una azotea: la ciudad amurallada sin una sola luz, el mar negro, y detrás de las lomas del interior un resplandor rojizo bajo en el horizonte (nunca una explosión); en primer plano, sobre una mesa de la azotea, una radio de pilas y un vaso. Sin personajes | Noche; dos fuentes: el resplandor lejano y el dial verde de la radio |
| `ep00-lamina-2` | El Borrado                | Plano medio en el archivo de la Oficina de Registro: estantes metálicos con carpetas; en el centro, un tambor de lámina con papeles ardiendo; una mujer de espaldas (moño, saco de registradora) arroja un legajo al fuego; al fondo, la puerta entreabierta y la sombra de dos hombres con linternas                 | Interior sin electricidad: solo el fuego y las linternas             |
| `ep00-lamina-3` | La Crecida y la fila      | Plano general: calle colonial inundada hasta los balcones, con una pasarela de tablas; al fondo, la Oficina de Registro con una ventanilla enrejada iluminada y una fila de personas de espaldas; detrás de la reja, un hombre de saco gris sella un papel                                                            | Amanecer gris; el sello y la ventanilla son el único dorado          |
...
| --------------------- | --------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------- |
| `ep00-lamina-boveda`  | `ep00-boveda` (bajar a la bóveda) | Plano general: sótano de cal con estantes metálicos llenos de libros y carpetas, una mesa larga con páginas puestas a secar, un tanque de sal, una lámpara de queroseno; escalera al fondo; sin personajes | Lámpara cálida en un cuarto frío; el papel es lo más claro de la escena |
